...
public class CLI {
    ...
    private Task[] tasks = new Task[] { new Task("Show First 10") {
        ...
        public boolean action() throws MalformedURLException, IOException {
            dao.DrawPieChartFromJSON("Top Demanding Companies", 10, true, "company_norm", "count",
                    "http://localhost:8080/jobs/jobs_per_company");
            return false;
        }
        ...
        @Override
        public boolean action() throws MalformedURLException, IOException {
            dao.DrawBarChartFromJSON("Top Needed Titles", 20, false, "title_norm", "count",
                    "http://localhost:8080/jobs/jobs_popularity");
            return false;
        }
        ...
        @Override
        public boolean action() throws MalformedURLException, IOException {
            dao.DrawBarChartFromJSON("Top Areas", 20, false, "location_norm", "count",
                    "http://localhost:8080/jobs/area_popularity");
            return false;
        }
    ...
    public void run() throws MalformedURLException, IOException {
        while (true) {
            ...
            do {
                ...
                if (input_value > 12 || input_value < 0)
